...
/**
 * Java implementation of the GetCareContacts responder interface
 *
 * @author Magnus Larsson
 */
public class JavaTestGroovyImpl implements GetCareContactsResponderInterface {

    private static final org.slf4j.Logger log = LoggerFactory.getLogger(JavaTestGroovyImpl.class);
    ...
    private CareContactType createResponseItem(String sourceSystemHSAId, String orgUnitHSAId, String registeredResidentId, String documentId) {
        ...
        log.debug("Created one response item for SourceSystemHSAId {}, orgUnitHSAId {}, registeredResidentId {} and documentId {}",
                new Object[] {sourceSystemHSAId, orgUnitHSAId, registeredResidentId, documentId});
