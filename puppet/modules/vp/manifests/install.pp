class vp::install {
  ...
  # extract vp-services
  exec { "vp-services" : 
    command => "/usr/bin/unzip /vagrant/puppet/files/vp-services-${vp::params::version}.zip",
...
#  }
  ...
  exec { "vp:unpack-vp-services-master" : 
    command => "/usr/bin/unzip /vagrant/puppet/files/vp-services-master.zip -d ${mule::params::mule_home}/apps/vp-services-${vp::params::version}/lib",
    group  => "mule",
