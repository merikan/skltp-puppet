...
# $ more /etc/yum.repos.d/logstash.repo
# [logstash-1.4]
...
# --> Also install openJdk 7, not good!
...
include gnome-system-monitor
    ...
    class soapui {
      exec { "unpack-soapui" : 
        command => "/bin/tar -zxvf /vagrant/puppet/binaries/rivta-box/SoapUI-5.1.3-linux-bin.tar.gz -C /home/skltp",
        creates => "/home/skltp/SoapUI-5.1.3",
        user => 'skltp',
        require => Class['graphical_desktop'], 
      }
    }
